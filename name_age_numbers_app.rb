...
post '/fav_nums' do
	...
	if sum < @@age.to_i
		erb :display_comment, :locals => {:sum => sum, :fav_num1 => fav_num1, :fav_num2 => fav_num2, :fav_num3 => fav_num3, :name => @@name, :result => "less"}
	elsif sum > @@age.to_i
		erb :display_comment, :locals => {:sum => sum, :fav_num1 => fav_num1, :fav_num2 => fav_num2, :fav_num3 => fav_num3, :name => @@name, :result => "more"}
	end
end
